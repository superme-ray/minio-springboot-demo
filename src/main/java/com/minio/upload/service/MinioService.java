package com.minio.upload.service;
...
public class MinioService {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            // 上传本地文件
            String url1 = uploadFile(bucket, objectKey, "C:\\Users\\Administrator\\Downloads\\ray1.png");
            // 输出  http://127.0.0.1:9000/public/demo/123.png
            System.out.println(url1);
            // 上传文件流
            String url2 = uploadInputStream(bucket, objectKey, new FileInputStream(new File("C:\\Users\\Administrator\\Downloads\\ray1.png")));
            // 输出  http://127.0.0.1:9000/public/demo/123.png
